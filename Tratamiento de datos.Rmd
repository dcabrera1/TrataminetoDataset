...
binom.test( x = 35, # horas trabajadas
            n = 50, # total de horas trabajadas
            p = 0.05, 
            alternative = "less", # en relación a la H.alternativa
            conf.level = 0.95)

```
Con un p-value = 1 mayor de 0.05 se aprueba la hipótesis nula H0.Por lo tanto, podemos concluir que la probabilidad de que una persona gane mas de 50K trabajando 35 horas es de un 70% y si influye la proporción de horas trabajadas con los ingresos.
...
```
Con un p-value = 1 mayor de 0.05 se aprueba la hipótesis nula H0.Por lo tanto, podemos concluir que la probabilidad de que una persona gane mas de 50K teniendo 25 años es de un 48% y si influye la edad con los ingresos.